...
var _user$project$Main$suiteN = function (size) {
	...
	return A3(
		...
		{
			ctor: '::',
			_0: A2(makeBench, 'List.foldl', _elm_lang$core$List$foldl),
			_1: {
				ctor: '::',
				_0: A2(makeBench, 'new foldl', _user$project$Main$newFoldl),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$main = _user$project$Benchmark_Program$program(
	{
		ctor: '::',
		_0: _user$project$Main$suiteN(10),
		_1: {
			ctor: '::',
			_0: _user$project$Main$suiteN(1000),
			_1: {
				ctor: '::',
				_0: _user$project$Main$suiteN(100000),
				_1: {
					ctor: '::',
					_0: _user$project$Main$suiteN(1000000),
					_1: {ctor: '[]'}
				}
			}
		}
